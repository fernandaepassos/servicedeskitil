<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EstruturaOrganizacional.aspx.cs" Inherits="EstruturaOrganizacional" %>
<%@ Register Src="WUCEstruturaOrganizacional.ascx" TagName="WUCEstruturaOrganizacional"
    TagPrefix="uc1" %>
            ...
            <div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr id="Tr2" runat="server">
                        <td height="6" align="center" valign="middle"><img name="" src="" width="1" height="6" alt="" /> </td>
                    </tr>
                    <tr>
                          ...
                          <tr>
                            <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabelaPadrao">
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" valign="top" class="centro_top"><table width="100%" height="22"  border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              ...
                                              <td align="left" valign="middle" class="tituloFont">Dados da Estrutura </td>
                                            </tr>
                                        </table></td>
                                ...
                                <tr>
								  ...
								  <uc1:WUCEstruturaOrganizacional id="WUCEstruturaOrganizacional1" runat="server"></uc1:WUCEstruturaOrganizacional>
								  </td>
                                </tr>
                                <tr>
