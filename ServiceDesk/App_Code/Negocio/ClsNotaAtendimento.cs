...
/// <summary>
/// Summary description for ClsNotaAtendimento
/// </summary>
/// 
...
namespace ServiceDesk.Negocio
{
    ...
    public class ClsNotaAtendimento
    {
        public ClsNotaAtendimento()
        {
        ...
        private ServiceDesk.Banco.ClsAtributo objDescricaoNota = new ServiceDesk.Banco.ClsAtributo();
        ...
        /// </summary>
        public ServiceDesk.Banco.ClsAtributo DescricaoNota
        {
            get { return objDescricaoNota; }
            set { this.objDescricaoNota = value; }
        }
        ...
        /// <summary>
        /// Tabela a qual o registro pertence.
        /// </summary>
        ...
        {
            objAtributos.NomeTabela = "Nota";
            objAtributos.DescricaoTabela = "Notas de Atendimento";

            objCodigo.Campo = "nota_codigo";
            ...
            objDescricaoNota.Campo = "nota";
            objDescricaoNota.Descricao = "Descrição";
            objDescricaoNota.CampoIdentificador = false;
            objDescricaoNota.CampoObrigatorio = true;
            objDescricaoNota.Tipo = System.Data.DbType.String;
            objAtributos.Add(objDescricaoNota);

            objCodigoPessoaInclusor.Campo = "pessoa_codigo";
            objCodigoPessoaInclusor.Descricao = "Código do Proprietário";
            ...
            objIdentificadorTabela.Descricao = "Registro Relacionado";
            ...
            objTabela.Descricao = "Nome da Tabela";
        ...
        public bool insere(out String strMensagem)
        {
            try
            {
                ...
                if (this.objDescricaoNota.Valor.Trim() == String.Empty)
                {
        ...
        public static void geraGridView(System.Web.UI.WebControls.GridView objGridView)
        {
            try
            {
                ...
                ServiceDesk.Controle.ClsGridView.geraGridView(objGridView, ObjNotaAtendimento.objAtributos);
        ...
        public static void geraGridView(System.Web.UI.WebControls.GridView objGridView, ClsNotaAtendimento ObjNotaAtendimento, bool bolCondicao)
        {
            try
            {
                objGridView.AutoGenerateColumns = false;
                ServiceDesk.Controle.ClsGridView.geraGridView(objGridView, ObjNotaAtendimento.objAtributos, bolCondicao);
            }
            catch (Exception ex)
            {
                throw ex;
