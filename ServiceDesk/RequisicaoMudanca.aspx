<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="RequisicaoMudanca.aspx.cs" Inherits="RequisicaoMudanca" %>

<%@ Register Src="WUCRequisicaoMudanca.ascx" TagName="WUCRequisicaoMudanca" TagPrefix="uc1" %>
...
<head id="Head1" runat="server">
    <title>Help Desk  ITIL Compliance :: Requisição de Mudança</title>
  ...
  <tr>
    ...
    <td align="center" valign="bottom"> <asp:Label ID="lblMensagem" runat="server" Font-Names="Trebuchet MS" ForeColor="#1D6E6F"></asp:Label></td>
                ...
                <tr id="Tr2" runat="server">
                  <td align="center" valign="middle"><img src="" width="1" height="6" alt="" /></td>
                </tr>
                <tr>
                        ...
                        <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabelaPadrao">
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top" class="centro_top"><table width="100%" height="22"  border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td align="left" valign="middle" class="tituloFont">Dados de Requisi&ccedil;&atilde;o de Mudan&ccedil;a </td>
                                        </tr>
                                    </table></td>
                            ...
                            <tr>
                              <td colspan="3" align="center" valign="top" class="fundo_tabela">
							   <uc1:WUCRequisicaoMudanca id="WUCRequisicaoMudanca1" runat="server"></uc1:WUCRequisicaoMudanca>
							  </td>
                            </tr>
                            <tr>
