<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="Incidente.aspx.cs" Inherits="Incidente" %>

<%@ Register Src="WUCIncidente.ascx" TagName="WUCIncidente" TagPrefix="uc2" %>
...
<head id="Head1" runat="server">
    <title>Help Desk  ITIL Compliance :: Incidente</title>
                      ...
                      <tr>
                        <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabelaPadrao">
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top" class="centro_top"><table width="100%" height="22"  border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td align="left" valign="middle" class="tituloFont">Dados do Incidente </td>
                                        </tr>
                                    </table></td>
                            ...
                            <tr>
							  ...
							  <uc2:WUCIncidente ID="WUCIncidente1" runat="server" OnLoad="WUCIncidente1_Load" />
							  </td>
                            </tr>
                            <tr>
