<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCMinhasRequisicoesServico.ascx.cs" Inherits="WUCMinhasRequisicoesServico" %>
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0" height="19">
                            <tr>
                                ...
                                <td class="aba_centro_off">
                                    Minhas Requisições de Serviço</td>
                                            ...
                                            <tr align="center" valign="top">
                                                <td colspan="5">
                                                    <asp:Panel ID="Panel1" runat="server" Height="350px" ScrollBars="Vertical" Width="760px" CssClass="dataGrid">
                                                        <asp:GridView ID="gvRequisicaoServico" runat="server" AutoGenerateColumns="False"
                                                            CellPadding="4" GridLines="None" HorizontalAlign="Center" OnRowDataBound="gvRequisicaoServico_RowDataBound"
