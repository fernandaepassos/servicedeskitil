<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoAcao.aspx.cs" Inherits="Acao" %>
...
<head id="Head1" runat="server">
    <title>Help Desk  ITIL Compliance :: Ação</title>
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" class="centro_top"><table width="100%" height="22"  border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td align="left" valign="middle" class="tituloFont">A&ccedil;&atilde;o</td>
                                    </tr>
                                </table></td>
                            ...
                            <tr>
                              <td align="center" valign="top">
                                <table width="92%"  border="0" cellspacing="2" cellpadding="0">
                                  <tr>
                                    <td width="68" align="left" valign="middle">Descri&ccedil;&atilde;o:</td>
                                    <td align="left" valign="middle">
                                      <asp:TextBox ID="txtDescricao" CssClass="campo_texto" runat="server" Width="500px"></asp:TextBox>                                    </td>
                                    <td align="left" valign="middle">
                                      <asp:Button ID="btnLimpar" Width="80px" CssClass="botao" runat="server" Text="Limpar" OnClick="btnLimpar_Click" />          </td>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td align="left"><table border="0" align="left"  cellpadding="0" cellspacing="0">
                                      <tr>
                                        ...
                                        <td class="aba_centro_off">A&ccedil;&atilde;o</td>
                                  ...
                                  <tr>
                                    <td align="center" valign="top">
									  ...
									  <asp:GridView ID="gvAcao" GridLines="None" Width="98%" HorizontalAlign="Center" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" runat="server" CellPadding="3" ShowFooter="False" OnRowCommand="gvAcao_OnRowCommand" OnRowDataBound="gvAcao_RowDataBound">
                                        ...
                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="650px" />                          
