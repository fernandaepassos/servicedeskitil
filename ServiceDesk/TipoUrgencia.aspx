<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoUrgencia.aspx.cs" Inherits="TipoUrgencia" %>
...
<head id="Head1" runat="server">
    <title>Help Desk  ITIL Compliance :: Urgência</title>
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" class="centro_top"><table width="100%" height="22"  border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td align="left" valign="middle" class="tituloFont">Urg&ecirc;ncia</td>
                                    </tr>
                                </table></td>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
									...
									<table border="0" align="left"  cellpadding="0" cellspacing="0">
                                      <tr>
                                        ...
                                        <td class="aba_centro_off">Urg&ecirc;ncia</td>
                                  ...
                                  <tr align="left">
                                    <td valign="top">
									  ...
									  <asp:GridView ID="gvUrgencia" GridLines="None" Width="98%" HorizontalAlign="Center" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" runat="server" CellPadding="3" ShowFooter="False" OnRowCommand="gvUrgencia_OnRowCommand" OnRowDataBound="gvUrgencia_RowDataBound">
                                        ...
                                        <ItemTemplate>
                                          <asp:Label ID="lblCodigo" Text='<%# DataBinder.Eval(Container.DataItem, "urgencia_codigo")%>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        ...
                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="610px" />                          
