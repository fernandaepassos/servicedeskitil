<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCRequisicaoServico.ascx.cs" Inherits="WUCRequisicaoServico" %>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr align="left" valign="top">
        <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="73">ID:</td>
            <td width="243"><asp:Label ID="lblPrefixo" runat=server BackColor=transparent></asp:Label><asp:Label ID="lblIDRequisicaoServico" runat="server" Width="100%"></asp:Label></td>
            <td width="172">Utilizar RS Template:</td>
            <td width="233"><asp:DropDownList ID="ddlRequisicaoServicoPreDefinido" runat="server" Width="100%"> </asp:DropDownList></td>
            <td width="55" align="center" valign="middle"><asp:Button ID="btnAplicaRequisicaoServicoPreDefinido" runat="server" CssClass="botao" OnClick="btnAplicaRequisicaoServicoPreDefinido_Click" Text="Herdar" Width="50px" /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="50%" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="left"><asp:DropDownList ID="ddlOrigemRequisicaoServico" runat="server" CssClass="campo_texto" Width="284px"> </asp:DropDownList></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td><uc2:WUCStatusWorkFlow ID="wucRequisicaoServicoStatus" runat="server"/></td>
            </tr>
            <tr>
              <td valign="top"></td>
            </tr>
            ...
            <asp:Button ID="btnEnviaParaBaseConhecimento" runat="server" Text="Envia KB" OnClick="btnEnviaParaBaseConhecimento_Click" ToolTip="Envia o registro do RequisicaoServico atual para base de conhecimento" CssClass="botao" />
            </td>
            </tr>
        </table></td>
      </tr>
    ...
    <td align="left" valign="top" class="tabela_abas">
      ...
      <asp:View ID="vwSolicitante" runat="server">
        ...
        <asp:View ID="vwChamados" runat="server">
            <asp:Panel ID="pnlChamados" runat="server" HorizontalAlign="Left" Width="100%" CssClass="dataGrid">
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="pnlFiltros" runat="server" Height="50px" Visible="False" Width="100%" CssClass="dataGrid">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr align="left">
                                          ...
                                          <td align="left"><asp:TextBox ID="txtCodigoChamadoFiltro" runat="server" Width="210px" CssClass="campo_texto"></asp:TextBox></td>
                                            <td width="95" align="left">
                                                &nbsp; Serviço:</td>
                                          <td align="left"><asp:DropDownList ID="ddlServicoFiltro" runat="server" Width="260px"></asp:DropDownList></td>
                                          <td width="140" align="center" valign="middle">
										  <asp:Button ID="btnFiltrarChamados" Width="120px" runat="server" CssClass="botao" OnClick="btnFiltrarChamados_Click" Text="Filtrar" />										  </td>
                                        </tr>
                                        <tr align="left">
                                            <td>Descrição:</td>
                                          <td align="left"><asp:TextBox ID="txtDescricaoFiltro" runat="server" Width="210px" CssClass="campo_texto"></asp:TextBox></td>
                                            <td align="left">
                                                &nbsp; Solicitante:</td>
                                            <td align="left">
                                          <asp:DropDownList ID="ddlSolicitanteFiltro" runat="server" Width="260px"></asp:DropDownList>                                                                                    </td>
                                            <td width="140" align="center" valign="middle">
											<asp:Button ID="btnGravarVinculos" runat="server" Width="120px" CssClass="botao" OnClick="btnGravarVinculos_Click"
                                                            Text="Vincular a Requisição" />
											</td>
                                      </tr>
                                  </table>
                                </asp:Panel>
                                <asp:Panel ID="pnlResultadoPesquisaChamado" runat="server" BorderWidth="0px" Height="50px" Visible="True" CssClass="dataGrid">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="topoGrid">
                                                                            <p class="MsoNormal" style="margin: 0cm 0cm 0pt">
                                                                                Descrição de Incidentes Pesquisados</p>
                                                                        </td>
                                                                    </tr>
                                                              </table>
                                                            </div>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                          <asp:Panel ID="pnlChamadosVinculados" runat="server" Height="100px" HorizontalAlign="Left"
              ...
              <tr>
                <td>
                  <uc1:WUCItemConfiguracaoTreeView ID="WUCItemConfiguracaoTreeView1" runat="server" Legenda="Itens de Configuração:"
                    TabelaRelacionada="RequisicaoServico" />
                  <br />
                </td>
              </tr>
            </table>
        ...
        <asp:View ID="vwAnexos" runat="server">
          <uc5:WUCAnexo ID="WUCAnexo1" runat="server" Altura="100" Largura="100%" TabelaRelacionada="RequisicaoServico" />
        </asp:View>
        <asp:View ID="vwLog" runat="server">
          <uc4:WUCLog ID="WUCLog1" runat="server" Altura="100px" Largura="100%" OrigemRelacionada="RequisicaoServico" />
        </asp:View>
